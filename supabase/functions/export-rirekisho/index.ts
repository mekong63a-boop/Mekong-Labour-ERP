...
serve(async (req) => {
  ...
  try {
    ...
    // === Health row 1: 身長, 血液型, メガネ無, 視力左右 ===
    r++;
    rowHeights.set(r, 20);
    label(r, 0, "身長"); merge(r, 0, r, 2);
    center(r, 3, p.height ? `${p.height}cm` : ""); merge(r, 3, r, 7);
    label(r, 8, "血液型"); merge(r, 8, r, 14);
    center(r, 15, p.blood_group || "不明"); merge(r, 15, r, 20);
    label(r, 21, "メガネ無"); merge(r, 21, r, 24);
    label(r, 25, "左："); merge(r, 25, r, 27);
    center(r, 28, "10/10"); merge(r, 28, r, 29);
    label(r, 30, "右："); merge(r, 30, r, 32);
    center(r, 33, "10/10"); merge(r, 33, r, LC);

    // === Health row 2: 体重, 聴力, 健康診断 ===
    r++;
    rowHeights.set(r, 20);
    label(r, 0, "体重"); merge(r, 0, r, 2);
    center(r, 3, p.weight ? `${p.weight}kg` : ""); merge(r, 3, r, 7);
    label(r, 8, "聴力"); merge(r, 8, r, 14);
    center(r, 15, "正常"); merge(r, 15, r, 20);
    label(r, 21, "健康診断"); merge(r, 21, r, 24);
    center(r, 25, "異常なし"); merge(r, 25, r, LC);
    ...
    center(r, 15, "無"); merge(r, 15, r, 20);
    label(r, 21, "Ｂ型肝炎"); merge(r, 21, r, 24);
    center(r, 25, "無"); merge(r, 25, r, LC);
