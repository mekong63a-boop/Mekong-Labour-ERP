-- Fix the get_trainee_full_profile function - use receiving_company_id instead of company_id
...
BEGIN
  ...
  -- Get company info (use receiving_company_id, not company_id)
  ...
  -- Get trainee reviews (no trainee_notes table, use reviews instead)
  notes_data := '[]'::jsonb;
