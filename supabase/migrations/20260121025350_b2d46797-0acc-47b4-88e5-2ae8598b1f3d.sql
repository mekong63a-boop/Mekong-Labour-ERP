-- Update get_trainee_full_profile to include training history (attendance + test_scores) and parent phones
...
BEGIN
  ...
  -- Get job category data (include name_japanese)
  ...
  result := jsonb_build_object(
    ...
    'parent_phone_1', CASE WHEN can_view_pii THEN trainee_record.parent_phone_1 ELSE public.mask_phone(trainee_record.parent_phone_1) END,
    'parent_phone_2', CASE WHEN can_view_pii THEN trainee_record.parent_phone_2 ELSE public.mask_phone(trainee_record.parent_phone_2) END,
