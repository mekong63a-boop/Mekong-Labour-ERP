-- Fix get_trainee_full_profile - remove violations query since table doesn't exist
...
BEGIN
  ...
  -- Get company info (use receiving_company_id)
  ...
  -- Notes data (no trainee_notes table exists)
  notes_data := '[]'::jsonb;

  -- Violations data (no violations table exists)
  violations_data := '[]'::jsonb;
